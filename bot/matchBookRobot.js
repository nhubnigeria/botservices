...
// module variables
const
	EVENT_URL = 'https://matchbook.com/events/horse-racing/uk/wetherby/755053722660014/live-betting/17-15-wetherby',
...
async function bot() {
	...
	// define selector for validation
	const raceSelector = await page.waitForSelector(SELECTIONS_CONTAINER_SELECTOR, {
		timeout: 180000
	}).catch((error) => {
		console.log('Race selector not found', error);
		process.exit(1);
	});
