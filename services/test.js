...
// module variables
const
  EVENT_URL = 'https://matchbook.com/events/horse-racing/uk/chepstow/755878626690014/live-betting/14-20-chepstow',
     ...
     (target, MATCHED_AMOUNT_SELECTOR) => {
      ...
      if(!target){
        console.error(`Failure: The value after evaluating '${SELECTIONS_CONTAINER_SELECTOR}' could not be verified`);
          ...
          // Grabbing first row
          let firstRow = target.children[0].children[0].className;
          if (!firstRow) console.error(`Failure: The Selector '${firstRow}' could not be verifed`);
          // get all array of odds
          let oddsCount = Array.from(document.querySelectorAll('.mb-price__odds'));
          // get all array of amounts
          let amountCount = Array.from(document.querySelectorAll('.mb-price__amount'));
          ...
          target.addEventListener("click", async function (e) {
            console.log(e.target)
             if((e.target.className == 'mb-price__odds') && (e.target.parentElement.parentElement.parentElement.className == 'mb-price mb-price--back  mb-price--level0')) {
              betType = 'b0';
              liquidity.push('b0')
            }
            else if((e.target.className == 'mb-price__odds') && (e.target.parentElement.parentElement.parentElement.className == 'mb-price mb-price--lay  mb-price--level0')) {
              betType = 'l0';
             liquidity.push('l0')
            }
            else if((e.target.className == 'mb-price__odds') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.className == 'mb-price mb-price--back  mb-price--level1')) {
              betType = 'b1';
              liquidity.push('b1')
            }
            else if((e.target.className == 'mb-price__odds') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.className == 'mb-price mb-price--lay  mb-price--level1')) {
              betType = 'l1';
              liquidity.push('l1')
            }
            else if((e.target.className == 'mb-price__odds') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.nextElementSibling.className == 'mb-price mb-price--back  mb-price--level2')) {
              betType = 'b2';
              liquidity.push('b2')
            }
            else if((e.target.className == 'mb-price__odds') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.nextElementSibling.className == 'mb-price mb-price--lay  mb-price--level2')) {
              betType = 'l2';
             liquidity.push('l2')
            }
            else if((e.target.className == 'mb-price__amount') && (e.target.parentElement.parentElement.parentElement.className == 'mb-price mb-price--back  mb-price--level0')) {
              betType = 'b0';
              odds.push('b0')
            }
            else if((e.target.className == 'mb-price__amount') && (e.target.parentElement.parentElement.parentElement.className == 'mb-price mb-price--lay  mb-price--level0')) {
              betType = 'l0';
              odds.push('l0')
            }
            else if((e.target.className == 'mb-price__amount') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.className == 'mb-price mb-price--back  mb-price--level1')) {
              betType = 'b1';
              odds.push('b1')
            }
            else if((e.target.className == 'mb-price__amount') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.className == 'mb-price mb-price--lay  mb-price--level1')) {
              betType = 'l1';
              odds.push('l1')
            }
            else if((e.target.className == 'mb-price__amount') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.nextElementSibling.className == 'mb-price mb-price--back  mb-price--level2')) {
              betType = 'b2';
              odds.push('b2')
            }
            else if((e.target.className == 'mb-price__amount') && (e.target.parentElement.parentElement.parentElement.nextElementSibling.nextElementSibling.className == 'mb-price mb-price--lay  mb-price--level2')) {
              betType = 'l2';
              odds.push('l2')
            }
